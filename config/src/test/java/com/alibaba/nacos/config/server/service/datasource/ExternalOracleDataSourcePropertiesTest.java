...
public class ExternalOracleDataSourcePropertiesTest {
    
    @SuppressWarnings("checkstyle:linelength")
    public static final String JDBC_URL = "jdbc:oracle:thin:@127.0.0.1/xe";
    ...
    public void externalDatasourceNormally() {
        ...
        List<HikariDataSource> dataSources = new ExternalOracleDataSourceProperties().build(environment, (dataSource -> {
